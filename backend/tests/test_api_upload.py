...
class TestUploadEndpoint:
    ...
    def test_rejects_empty_file(self, mock_payment, client):
        mock_payment.check_quota = AsyncMock(return_value=(True, 2))
    ...
    def test_quota_exceeded_402(self, mock_payment, client):
        mock_payment.check_quota = AsyncMock(return_value=(False, 0))
        mock_payment.FREE_TIER_LIMIT = 2
        mock_payment.create_checkout_session = AsyncMock(return_value="/pricing")
